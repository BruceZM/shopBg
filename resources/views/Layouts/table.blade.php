    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>                    
                    <li class=@yield("active1")><a href="##"><i class="icon-table"></i> 用户管理</a>
                        <ul>                        
                            <li><a href="{{url('Users')}}">查看用户</a></li>                            
                            <li><a href="{{url('Users/create')}}">添加用户</a></li>
                            <li><a href="{{url('Users/destroy')}}">回收站</a></li>
                        </ul>
                    </li>                   
                    <li class=@yield("active2")><a href="##"><i class="icon-table"></i> 文章管理</a>
                         <ul>
                    ...
                    <li class=@yield("active3")><a href="##"><i class="icon-shopping-cart"></i> 分类管理</a>
                         <ul>
                            <li><a href="{{url('Cates')}}">查看分类</a></li>                         
                            <li><a href="{{url('Cates/create')}}">添加分类</a></li>
                            <li><a href="{{url('Cates/destroy')}}">回收站</a></li>
                        </ul>
                    </li>
                    <li class=@yield("active4")><a href="##"><i class="icon-shopping-cart"></i> 商品管理</a>
                         <ul>
                            <li><a href="{{url('Goods')}}">查看商品</a></li>                         
